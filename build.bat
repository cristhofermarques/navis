...
set VULKAN_SDK_DIRECTORY=C:/VulkanSDK/1.3.250.0
...
if %BUILD_KIND%==shared ( set BUILD_COMMAND=%BUILD_COMMAND% -define:NAVIS_EXPORT=true)
if %BUILD_KIND%==shared ( set BUILD_COMMAND=%BUILD_COMMAND% -define:NAVIS_IMPLEMENTATION=true)
set BUILD_COMMAND=%BUILD_COMMAND% -define:NAVIS_VERBOSE=%BUILD_VERBOSE%
set BUILD_COMMAND=%BUILD_COMMAND% -define:NAVIS_VERSION_MAJOR=%MAJOR_VERSION%
set BUILD_COMMAND=%BUILD_COMMAND% -define:NAVIS_VERSION_MINOR=%MINOR_VERSION%
set BUILD_COMMAND=%BUILD_COMMAND% -define:NAVIS_VERSION_PATCH=%PATCH_VERSION%
