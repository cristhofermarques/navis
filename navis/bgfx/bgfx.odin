...
foreign bgfx
{
    ...
    attachment_init :: proc "c" (_this: ^Attachment, _handle: TextureHandle, _access: Access, _layer: u16, _numLayers: u16, _mip: u16, _resolve: u8) ---
    ...
    create_texture :: proc "c" (_mem: ^Memory, _flags: u64, _skip: u8, _info: ^TextureInfo) -> TextureHandle ---

    @(link_name="bgfx_create_texture_2d")
    create_texture_2d :: proc "c" (_width: u16, _height: u16, _hasMips: b8, _numLayers: u16, _format: Texture_Format, _flags: u64, _mem: ^Memory) -> TextureHandle ---

    @(link_name="bgfx_create_texture_2d_scaled")
    create_texture_2d_scaled :: proc "c" (_ratio: Backbuffer_Ratio, _hasMips: b8, _numLayers: u16, _format: Texture_Format, _flags: u64) -> TextureHandle ---

    @(link_name="bgfx_create_texture_3d")
    create_texture_3d :: proc "c" (_width: u16, _height: u16, _depth: u16, _hasMips: b8, _format: Texture_Format, _flags: u64, _mem: ^Memory) -> TextureHandle ---

    @(link_name="bgfx_create_texture_cube")
    create_texture_cube :: proc "c" (_size: u16, _hasMips: b8, _numLayers: u16, _format: Texture_Format, _flags: u64, _mem: ^Memory) -> TextureHandle ---

    @(link_name="bgfx_update_texture_2d")
    update_texture_2d :: proc "c" (_handle: TextureHandle, _layer: u16, _mip: u8, _x: u16, _y: u16, _width: u16, _height: u16, _mem: ^Memory, _pitch: u16) ---

    @(link_name="bgfx_update_texture_3d")
    update_texture_3d :: proc "c" (_handle: TextureHandle, _mip: u8, _x: u16, _y: u16, _z: u16, _width: u16, _height: u16, _depth: u16, _mem: ^Memory) ---

    @(link_name="bgfx_update_texture_cube")
    update_texture_cube :: proc "c" (_handle: TextureHandle, _layer: u16, _side: u8, _mip: u8, _x: u16, _y: u16, _width: u16, _height: u16, _mem: ^Memory, _pitch: u16) ---

    @(link_name="bgfx_read_texture")
    read_texture :: proc "c" (_handle: TextureHandle, _data: rawptr, _mip: u8) -> u32 ---

    @(link_name="bgfx_set_texture_name")
    set_texture_name :: proc "c" (_handle: TextureHandle, _name: cstring, _len: i32) ---

    @(link_name="bgfx_get_direct_access_ptr")
    get_direct_access_ptr :: proc "c" (_handle: TextureHandle) -> rawptr ---

    @(link_name="bgfx_destroy_texture")
    destroy_texture :: proc "c" (_handle: TextureHandle) ---

    @(link_name="bgfx_create_frame_buffer")
    create_frame_buffer :: proc "c" (_width: u16, _height: u16,_format :Texture_Format,_textureFlags :u64) -> FrameBufferHandle ---

    @(link_name="bgfx_create_frame_buffer_scaled")
    create_frame_buffer_scaled :: proc "c" (_ratio: Backbuffer_Ratio, _format: Texture_Format, _textureFlags: u64) -> FrameBufferHandle ---

    @(link_name="bgfx_create_frame_buffer_from_handles")
    create_frame_buffer_from_handles :: proc "c" (_num: u8, _handles: ^TextureHandle, _destroyTexture: b8) -> FrameBufferHandle ---

    @(link_name="bgfx_create_frame_buffer_from_attachment")
    create_frame_buffer_from_attachment :: proc "c" (_num: u8, _attachment: ^Attachment, _destroyTexture: b8) -> FrameBufferHandle ---

    @(link_name="bgfx_create_frame_buffer_from_nwh")
    create_frame_buffer_from_nwh :: proc "c" (_nwh: rawptr, _width: u16, _height: u16, _format: Texture_Format, _depthFormat: Texture_Format) -> FrameBufferHandle ---

    @(link_name="bgfx_set_frame_buffer_name")
    set_frame_buffer_name :: proc "c" (_handle: FrameBufferHandle, _name: cstring, _len: i32) ---

    @(link_name="bgfx_get_texture")
    get_texture :: proc "c" (_handle: FrameBufferHandle, _attachment: u8) -> TextureHandle ---
    ...
    encoder_set_texture :: proc "c" (_this: ^Encoder, _stage: u8, _sampler: Uniform_Handle, _handle: TextureHandle, _flags: u32) ---
    ...
    encoder_set_image :: proc "c" (_this: ^Encoder, _stage: u8, _handle: TextureHandle, _mip: u8, _access: Access, _format: Texture_Format) ---
    ...
    encoder_blit :: proc "c" (_this:^Encoder,_id :View_ID,_dst :TextureHandle,_dstMip :u8,_dstX :u16,_dstY :u16,_dstZ :u16,_src :TextureHandle,_srcMip :u8,_srcX :u16,_srcY :u16,_srcZ :u16,_width :u16,_height :u16,_depth :u16) ---

    @(link_name="bgfx_request_screen_shot")
    request_screen_shot :: proc "c" (_handle: FrameBufferHandle, _filePath: cstring) ---
    ...
    override_internal_texture_ptr :: proc "c" (_handle: TextureHandle, _ptr: rawptr) -> rawptr ---

    @(link_name="bgfx_override_internal_texture")
    override_internal_texture :: proc "c" (_handle: TextureHandle, _width: u16, _height: u16, _numMips: u8, _format: Texture_Format, _flags: u64) -> rawptr ---
    ...
    set_texture :: proc "c" (_stage :u8,_sampler :Uniform_Handle,_handle :TextureHandle,_flags :u32) ---
    ...
    set_image :: proc "c" (_stage :u8,_handle :TextureHandle,_mip :u8,_access :Access,_format :Texture_Format) ---
    ...
    @(link_name="bgfx_blit")
    blit :: proc "c" (_id :View_ID,_dst :TextureHandle,_dstMip :u8,_dstX :u16,_dstY :u16,_dstZ :u16,_src :TextureHandle,_srcMip :u8,_srcX :u16,_srcY :u16,_srcZ :u16,_width :u16,_height :u16,_depth :u16) ---
}
